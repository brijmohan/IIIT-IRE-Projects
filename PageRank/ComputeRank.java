...
public class ComputeRank {
    ...
    public void compute() {
        ...
        Map<Integer,Float> pageRankNew= new HashMap<Integer, Float>();
        Map<Integer,Integer> outLink=new HashMap<Integer,Integer>();

        //New Code
        Map<Integer,List<Integer>> inLnk=new LinkedHashMap<Integer,List<Integer>>();
        ...
        try {
            ...
            while (true){
                ...
                while ((line=bufferedReader2.readLine())!=null){
                    ...
                    pageRankNew.put(pageId,val);
                }
                System.out.println(i);
                i++;
                pageRank.putAll(pageRankNew);
                pageRankNew.clear();
                if(i%10==0){
                    System.out.println("Writing");
                    BufferedWriter bufferedWriter=new BufferedWriter(new FileWriter(PATH+"/pageRank"+i));
